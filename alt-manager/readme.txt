...
<p>This Plugin can significantly improve your website images SEO with the dynmamic values generated by the plugins settings. This plugin bulk changes images Alt and Title attributes immediately on your website front end, you don’t need to change image info on media library.</p>
...
<dt id="how"><h3><button formaction="#how">How to Use Image Alt Text Manager?</button></h3></dt>
...
<ul>
<li>
Please be sure you selected Alt And Title settings through Image Alt Text Manager settings on admin dashboard <strong>Dashboard -> Settings -> Image Alt Text Manager</strong>.
</li>
<li>
